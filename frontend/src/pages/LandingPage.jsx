          ...
          >
            <div className="container">
              <div className="hero-text-box text-center">
                ...
                <div className="landing-hero-btn d-inline-block position-relative">
                  <span className="hero-btn-item position-absolute d-none d-md-flex text-heading">
                    Join community
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/Join-community-arrow.png"
                      alt="Join community arrow"
                      className="scaleX-n1-rtl"
                    />
                  </span>
                  <a href="#landingPricing" className="btn btn-primary">
                    Get early access
                  </a>
                </div>
              </div>
              <div id="heroDashboardAnimation" className="hero-animation-img">
                <a
                  href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/app/ecommerce/dashboard"
                  target="_blank"
                >
                  <div
                    id="heroAnimationImg"
                    ...
                    style={{
                      transform:
                        "perspective(1200px) scale(1) rotateX(0deg) rotateY(0deg)",
                    }}
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/hero-dashboard-light.png"
                      alt="hero dashboard"
                    ...
                    />
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/hero-elements-light.png"
                      alt="hero elements"
        ...
        <section id="landingFeatures" className="section-py landing-features">
          <div className="container">
            ...
            <h3 className="text-center mb-1">
              <span className="section-title">Everything you need</span> to
            ...
            <div className="features-icon-wrapper row gx-0 gy-4 g-sm-5">
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/laptop.png"
                    alt="laptop charging"
                  />
                </div>
              ...
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/rocket.png"
                    alt="transition up"
                  />
                </div>
              ...
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/paper.png"
                    alt="edit"
                  />
                </div>
              ...
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/check.png"
                    alt="3d select solid"
                  />
                </div>
              ...
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/user.png"
                    alt="lifebelt"
                  />
                </div>
              ...
              <div className="col-lg-4 col-sm-6 text-center features-icon-box">
                <div className="text-center mb-3">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/keyboard.png"
                    alt="google docs"
                  />
                </div>
                ...
                <div className="swiper-reviews-carousel overflow-hidden mb-5 pb-md-2 pb-md-3">
                  ...
                  >
                    <div
                      ...
                      id="swiper-wrapper-2110cbb573d115910f"
                      aria-live="off"
                      style={{
                        cursor: "grab",
                        transitionDuration: "300ms",
                        transform: "translate3d(-1745px, 0px, 0px)",
                      }}
                    >
                      <div
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-1.png"
                                alt="client logo"
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-2.png"
                                alt="client logo"
                                className="client-logo img-fluid"
                              />
                            </div>
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-3.png"
                                alt="client logo"
                                className="client-logo img-fluid"
                              />
                            </div>
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-4.png"
                                alt="client logo"
                                className="client-logo img-fluid"
                              />
                            </div>
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-5.png"
                                alt="client logo"
                                className="client-logo img-fluid"
                              />
                            </div>
                      ...
                      >
                        <div className="card h-100">
                          <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                              <img
                                src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo-6.png"
                                alt="client logo"
                                className="client-logo img-fluid"
                              />
                            </div>
                    ...
                    <div
                      ...
                      aria-controls="swiper-wrapper-2110cbb573d115910f"
                    />
                    <div
          ...
          <div className="container">
            <div className="swiper-logo-carousel py-4 my-lg-2">
              ...
              >
                <div
                  className="swiper-wrapper"
                  id="swiper-wrapper-bec2b8836a1efc98"
                  aria-live="off"
                >
                  <div
                    className="swiper-slide swiper-slide-active"
                  ...
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo_1-light.png"
                      alt="client logo"
                  ...
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo_2-light.png"
                      alt="client logo"
                      className="client-logo"
                  ...
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo_3-light.png"
                      alt="client logo"
                      className="client-logo"
                  ...
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo_4-light.png"
                      alt="client logo"
                      className="client-logo"
                  ...
                  >
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/branding/logo_5-light.png"
                      alt="client logo"
                      className="client-logo"
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card mt-3 mt-lg-0 shadow-none">
                  <div className="bg-label-primary position-relative team-image-box">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-1.png"
                      className="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl img-fluid"
                      alt="human image"
                    />
                  </div>
                  <div className="card-body border border-label-primary border-top-0 text-center">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card mt-3 mt-lg-0 shadow-none">
                  <div className="bg-label-info position-relative team-image-box">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-2.png"
                      className="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl img-fluid"
                      alt="human image"
                    />
                  </div>
                  <div className="card-body border border-label-info border-top-0 text-center">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card mt-3 mt-lg-0 shadow-none">
                  <div className="bg-label-danger position-relative team-image-box">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-3.png"
                      className="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl img-fluid"
                      alt="human image"
                    />
                  </div>
                  <div className="card-body border border-label-danger border-top-0 text-center">
              ...
              <div className="col-lg-3 col-sm-6">
                <div className="card mt-3 mt-lg-0 shadow-none">
                  <div className="bg-label-success position-relative team-image-box">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/team-member-4.png"
                      className="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl img-fluid"
                      alt="human image"
                    />
                  </div>
                  <div className="card-body border border-label-success border-top-0 text-center">
            ...
            <div className="text-center mb-5">
              <div className="position-relative d-inline-block pt-3 pt-md-0">
                ...
                <div className="pricing-plans-item position-absolute d-flex">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/pricing-plans-arrow.png"
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="text-center">
                      <img
                        src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/paper-airplane.png"
                        alt="paper airplane icon"
                        className="mb-4 pb-2 scaleX-n1-rtl"
                      />
                      <h4 className="mb-1">Basic</h4>
                      <div className="d-flex align-items-center justify-content-center">
                        <span className="price-monthly h1 text-primary fw-bold mb-0 d-none">
                          $19
                        </span>
                        <span className="price-yearly h1 text-primary fw-bold mb-0">
                          $14
                        </span>
                        <sub className="h6 text-muted mb-0 ms-1">/mo</sub>
                      </div>
                      <div className="position-relative pt-2">
                        <div className="price-yearly text-muted price-yearly-toggle">
                          $ 168 / year
                        </div>
                      </div>
                    </div>
              ...
              <div className="col-xl-4 col-lg-6">
                <div className="card border border-primary shadow-lg">
                  <div className="card-header">
                    <div className="text-center">
                      <img
                        src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/plane.png"
                        alt="plane icon"
                        className="mb-4 pb-2 scaleX-n1-rtl"
                      />
              ...
              <div className="col-xl-4 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="text-center">
                      <img
                        src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/shuttle-rocket.png"
            ...
            <div className="row gy-3">
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="card border border-label-success shadow-none">
                  <div className="card-body text-center">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/user-success.png"
                      alt="laptop"
                      className="mb-2"
                    />
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="card border border-label-info shadow-none">
                  <div className="card-body text-center">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/diamond-info.png"
                      alt="laptop"
                      className="mb-2"
                    />
              ...
              <div className="col-sm-6 col-lg-3">
                <div className="card border border-label-warning shadow-none">
                  <div className="card-body text-center">
                    <img
                      src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/check-warning.png"
                      alt="laptop"
                      className="mb-2"
                    />
          ...
          <div className="container">
            ...
            <div className="row gy-5">
              <div className="col-lg-5">
                <div className="text-center">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/faq-boy-with-logos.png"
          ...
          <div className="container">
            <div className="row align-items-center gy-5 gy-lg-0">
              ...
              <div className="col-lg-6 pt-lg-5 text-center text-lg-end">
                <img
                  src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/cta-dashboard.png"
                  alt="cta dashboard"
                  className="img-fluid"
                />
              </div>
            ...
            <div className="row gy-4">
              <div className="col-lg-5">
                <div className="contact-img-box position-relative border p-2 h-100">
                  <img
                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/landing-page/contact-customer-service.png"
                    alt="contact customer service"
                    className="contact-img w-100 scaleX-n1-rtl img-fluid"
                  />
                  ...
                  >
                    <g id="Icon" transform="translate(27.000000, 15.000000)">
                      <g id="Mask" transform="translate(0.000000, 8.000000)">
                        ...
                        <use fill="var(--bs-primary)" xlinkHref="#path-1" />
                        <g id="Path-3" mask="url(#mask-2)">
                          <use fill="var(--bs-primary)" xlinkHref="#path-3" />
                          <use
                            fillOpacity="0.2"
                            fill="#FFFFFF"
                            xlinkHref="#path-3"
                        ...
                        <g id="Path-4" mask="url(#mask-2)">
                          <use fill="var(--bs-primary)" xlinkHref="#path-4" />
                          <use
                            fillOpacity="0.2"
                            fill="#FFFFFF"
                            xlinkHref="#path-4"
                      ...
                      >
                        <use fill="var(--bs-primary)" xlinkHref="#path-5" />
                        <use
                          fillOpacity="0.2"
                          fill="#FFFFFF"
                          xlinkHref="#path-5"
        ...
        <div className="col-lg-2 col-md-4 col-sm-6">
          ...
          <ul className="list-unstyled">
            ...
            <li className="mb-3">
              ...
              >
                Payment
                <span className="badge rounded bg-primary ms-2 px-2">New</span>
              </a>
            </li>
            <li className="mb-3">
              <a
  ...
  <div className="footer-bottom py-3">
    <div className="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        ...
        >
          <img
            src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/github-light.png"
            alt="github icon"
        ...
        >
          <img
            src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/facebook-light.png"
            alt="facebook icon"
        ...
        >
          <img
            src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/twitter-light.png"
            alt="twitter icon"
        ...
        >
          <img
            src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/front-pages/icons/instagram-light.png"
            alt="google icon"
